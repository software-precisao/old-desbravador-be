...
module.exports = (sequelize, DataTypes) => {
  class TraderSessionSetupIndicator extends Model {
    static associate(models) {
      TraderSessionSetupIndicator.belongsTo(models.TraderSessionSetup, { foreignKey: 'traderSessionSetupId' });
    }
  }
  TraderSessionSetupIndicator.init({
    traderSessionSetupId: DataTypes.INTEGER,
  ...
  sequelize,
  tableName: 'TraderSessionSetupIndicator',
});
return TraderSessionSetupIndicator;
};
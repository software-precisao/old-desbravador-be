...
module.exports = {
  async up(queryInterface, DataTypes) {
    await queryInterface.createTable('TraderSessionSetupIndicator', {
      id: {
        allowNull: false,
        autoIncrement: true,
        primaryKey: true,
      ...
      traderSessionSetupId: {
        allowNull: false,
        type: DataTypes.INTEGER,
        references: { model: { tableName: 'TraderSessionSetup' }, key: 'id' },
        onUpdate: 'CASCADE',
        onDelete: 'CASCADE'
      },
      typeStrategy: {
  ...
  async down(queryInterface, DataTypes) {
    await queryInterface.dropTable('TraderSessionSetupIndicator');
  }
};